 ...
 */
private class HappeningScreenStateProvider : PreviewParameterProvider<HappeningUiModel> {
    override val values =
        sequenceOf(
...
private fun HappeningScreenPreview(
    @PreviewParameter(HappeningScreenStateProvider::class) state: HappeningUiModel,
) {
    YadloPreview {
        HappeningScreen(
            state = state,
