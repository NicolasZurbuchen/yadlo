package io.nicolaszurbuchen.yadlo.core.plan.domain.fake
...
/**
 * Shared for the same reason [io.nicolaszurbuchen.yadlo.core.content.domain.fake.FakeContentRepository]
